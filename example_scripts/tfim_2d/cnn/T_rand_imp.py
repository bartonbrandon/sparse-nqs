...
init_path = '' # TODO: Insert your path to a new initialization here (not IMP_WR initialization)
path_to_mask = '' # TODO: Insert your path to IMP-WR data here


# Isolated training from a selected pruning iteration
selected_pruning_iteration = 5 # For example
pruner.T_rand_imp(t_rewind_iteration=selected_pruning_iteration, 
