...
# Train in isolation from a selected iteration of IMP-WR
select_pruning_iteration = 5 # For example
pruner.T_init_imp(t_rewind_iteration=select_pruning_iteration, 
