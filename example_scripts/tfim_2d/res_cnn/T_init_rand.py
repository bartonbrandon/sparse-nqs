...
init_path = '' # TODO: Add path to IMP-WR data

# Train in isolation from a selected network density
starting_density = 0.5 # For example
pruner.T_init_rand(pruning_protocol='res_blocks_random_global', 
