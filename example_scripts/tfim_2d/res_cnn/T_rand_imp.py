...
from src.networks.prunable_res_cnn import *
...
pruning_protocol = 'res_blocks_global'
pruning_ratio = 0.12
weight_rewinding = True
pruning_its = 60
sampling_its = 100
network_type = 'PrunableResCNN'
...
save_data_path = '' # TODO: Add path to save data
...
network = PrunableResCNN(**network_params)
...
init_path = '' # TODO: Add path to a new initialization (not IMP-WR initialization)
path_to_mask = '' # TODO: Add path to IMP-WR data

# Train in isolation from a selected IMP-WR iteration
selected_iteration = 3 # For example
pruner.T_rand_imp(t_rewind_iteration=selected_iteration, 
