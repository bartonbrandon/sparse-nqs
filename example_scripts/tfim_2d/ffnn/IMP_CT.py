...
pruning_ratio = 0.1
weight_rewinding = False # CONTINUED TRAINING
pruning_its = 100
sampling_its = 20
...
save_data_path = '' # TODO: Add your file path here
...
init_path = '' # TODO: Add your file path here from IMP-WR script

# Iterative magnitude pruning with continued training
pruner.IMP_CT(init_path=init_path, save_data=True, save_data_path=save_data_path)