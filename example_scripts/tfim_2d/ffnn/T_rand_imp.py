...
init_path = '' # TODO: Insert path to a new initialization (not the IMP-WR init)
path_to_mask = '' # TODO: Insert path to the IMP-WR data

# Train in isolation from a selected iteration
