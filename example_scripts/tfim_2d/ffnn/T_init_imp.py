...
init_path = '' # TODO: Add your path here from the IMP-WR script

# Isolated training from a selected iteration
selected_iteration = 5
pruner.T_init_imp(t_rewind_iteration=selected_iteration, save_data_path=save_data_path, init_path=init_path)